...
import { AtRiskView, type AtRiskRow } from "./at-risk-view";
...
export default async function AtRiskPage() {
  const user = await requireFeature(FEATURES.AT_RISK_DETECTION, ROLES.DIRECTOR);
  ...
  return <AtRiskView students={rows} scope="school" />;
}
